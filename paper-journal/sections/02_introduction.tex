...
The remainder of this paper is organized as follows: Section~\ref{sec:related_work} reviews related work; Section~\ref{sec:method} presents the ApproxDA-TransUNet framework; Section~\ref{sec:experiments} reports results against state-of-the-art baselines; Section~\ref{sec:gcs_mechanism} investigates the GCS spectrum and establishes Semantic Spatial Dependency through causal elimination; Section~\ref{sec:generalization} analyzes training optimization volatility and gate collapse dynamics; Section~\ref{sec:conclusion} concludes with practical design guidelines.
