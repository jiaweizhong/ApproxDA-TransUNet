...
\item \textbf{Empirical discovery of GCS}: Using ApproxDA-TransUNet as a controllable experimental platform, we present a systematic empirical study of attention approximation across heterogeneous medical segmentation tasks, uncovering up to a 4.6$\times$ difference in window sensitivity across four benchmarks. We term this task-level variability \emph{Global Context Sensitivity (GCS)} and demonstrate that it predicts window-tuning importance across tasks.
