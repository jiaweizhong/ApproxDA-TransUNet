...
\title{ApproxDA-TransUNet: Understanding Global Context Sensitivity of Attention Approximation for Medical Image Segmentation}
...
\input{sections/journal_gcs_mechanism}
