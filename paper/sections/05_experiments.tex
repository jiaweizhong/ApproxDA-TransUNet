...
ApproxDA-TransUNet achieves state-of-the-art results across all three benchmarks (Figure~\ref{fig:qualitative}), with task-dependent window sensitivity emerging as the key differentiating pattern across datasets.
