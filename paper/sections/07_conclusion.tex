...
Together, these findings establish Global Context Requirement (GCR) as a practical criterion for predicting whether attention approximation will be beneficial or harmful for a given segmentation task---shifting the research question from \emph{how to approximate} to \emph{when to approximate}.
