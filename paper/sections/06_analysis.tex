...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\columnwidth]{figures/attn_Kvasir_M7_r32_pam_vs_M112.png}
...
\begin{figure}[ht]
  ...
  \caption{Gate value vs.\ per-block feature entropy $H(F)$ ($M{=}7$, gate=learn). Panels (TL$\to$BR): \texttt{embeddings.approx\_block} (bottleneck), \texttt{0.da3}, \texttt{1.da2}, \texttt{2.da} (skip connections at 28$^2$, 56$^2$, 112$^2$). All four locations collapse to $g{\approx}0.5$ with $\Delta g{\leq}0.0002$, confirming uniform gate collapse across scales.}
