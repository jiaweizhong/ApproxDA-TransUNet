...
Figure~\ref{fig:framework} illustrates the overall ApproxDA architecture. Figure~\ref{fig:approxda_block} details the internal structure of each ApproxDABlock.
...
\begin{figure}[t]
  ...
  \end{tikzpicture}
  \caption{ApproxDA's three-dimensional approximation space. Each axis is independently controllable. Spatial scope ($M$) most directly governs long-range context capture and thereby approximation effectiveness on high-CS tasks.}
